...
export function HomeView({ onOpenNotifications }: HomeViewProps) {
  return (
    <div className="flex-1 w-full flex flex-col min-h-0 bg-[#000000] text-white overflow-y-auto pb-[100px] animate-fade-in">
      ...
      <div className="flex items-center justify-between px-6 pt-6 pb-4">
        ...
        <button
          ...
          className="w-10 h-10 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-300 relative transition-transform active:scale-95 hover:bg-[#1B1D22]"
        >
